<aside class="sidebar">
    <div class="scrollbar-inner">
        ...
        <ul class="navigation">
            ...
            <li
                class="navigation__sub <?php echo (in_array($this->router->fetch_class(), [
            ...
            <li class="<?php echo ($this->router->fetch_class() === 'donation') ? 'navigation__active' : '' ?>">
                <a href="<?php echo base_url('panel/donation/') ?>"><i class="zmdi zmdi-money-box"></i> Donation</a>
            </li>
        </ul>
    </div>
</aside>
